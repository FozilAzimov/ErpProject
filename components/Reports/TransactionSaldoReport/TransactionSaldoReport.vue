      ...
      >
        ...
        <div class="flex gap-8">
          ...
          <ul class="flex flex-col gap-4 justify-start w-[300px]">
            ...
            <li class="flex justify-between">
              <label>Show/Hide Person </label>
              <el-checkbox v-model="showHidePerson" size="large" />
            </li>
          ...
          <ul class="flex flex-col gap-4 justify-start w-[300px]">
            <li class="flex justify-between"><span>Saldo:</span></li>
        ...
        <div class="w-full">
          <table class="w-full border-[1px] border-collapse border-black">
            ...
            <tbody>
              <tr>
                <td class="border-[1px] border-collapse border-black">Saldo</td>
                <td
                  class="border-[1px] border-collapse border-black text-center"
                >
                  0
            ...
            <tbody>
              <tr>
                <td class="border-[1px] border-collapse border-black">
                  Report Saldo
                </td>
                <td
                  class="border-[1px] border-collapse border-black text-center"
