    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          @click="$router.push('/prepareDistanceToTerminal.htm')"
        />
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareDistanceToTerminal"
  ...
  methods: {
    ...
    createDataFiltering() {
      const createDate = [
        ...
        {
          name: 'Cluster Season Year',
          subName: 'clusterSeasonYearId',
          type: 'select',
        },
        {
          name: 'Cluster Season Name',
          subName: 'clusterSeasonNameId',
          type: 'select',
        },
      ]
