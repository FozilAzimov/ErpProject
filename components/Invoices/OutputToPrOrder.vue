    ...
    getTableRequest() {
      ...
      const body = {
        ...
        warehouseId: this.allSelectAndInputValues?.warehouseId
          ...
          : null,
        statusType: this.allSelectAndInputValues?.statusType
          ? this.allSelectAndInputValues?.statusType
          : null,
      }
      // request body
      this.isLoading = !this.isLoading
      this.$axios
        .post(`/invoices/outputToPrOrder`, body)
        .then(({ data }) => {
          this.actionUrl = data?.actionUrl
          this.tableHead = data?.rightMap
          this.leftMap = data?.leftMap
          this.selectData.warehouseList = data?.invoiceSearchDTO?.warehouseList
          // function
    ...
    createDataFiltering() {
      const createDate = [
        ...
        },
        {
          name: 'Invoice Status',
          subName: 'statusType',
          selectName: 'statusTypeList',
          type: 'select',
        },
      ]
      this.topFilterData = createDate

      this.selectData.statusTypeList = [
        { id: 'OUTPUT_TO_PR_ORDER', name: 'OUTPUT_TO_PR_ORDER' },
        { id: 'OUTPUT_TO_EQUIPMENT', name: 'OUTPUT_TO_EQUIPMENT' },
      ]
    },
  },
}
