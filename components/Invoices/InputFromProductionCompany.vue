    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          @click="$router.push('/prepareInputFromProductionCompanyNew.htm')"
        />
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareInputFromProductionCompanyNew"
            height="600"
          />
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        .post(`/invoices/inputFromProductionCompany`, body)
        .then(({ data: { actionUrl, invoiceList, rightMap, leftMap } }) => {
