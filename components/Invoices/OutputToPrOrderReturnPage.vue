      ...
      >
        <div class="flex items-center gap-2 m-2">
          <generic-button
            name="Add New"
            type="primary"
            @click="$router.push('/prepareOutputToPrOrderReturn.htm')"
          />
          <generic-button
            name="Return Experience on Equipments"
            type="primary"
            @click="$router.push('/prepareOutputToEquipmentReturn.htm')"
          />
        </div>
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareOutputToPrOrderReturn"
            height="600"
          />
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        .post(`/invoices/outputToPrOrderReturn`, {
          current_page: 1,
