      ...
      >
        <div class="flex items-center m-2 gap-1">
          <generic-button
            ...
            @click="$router.push('/prepareInputReturnNew.htm')"
          />
        </div>
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareInputReturnNew"
            height="600"
          />
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        .post(`/invoices/inputReturn`, body)
        .then(
          ({
            data: {
              invoiceSearchDTO,
              invoicesDTO: { actionUrl, invoiceList, rightMap, leftMap },
            },
          }) => {
