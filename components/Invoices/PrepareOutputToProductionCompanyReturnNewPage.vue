    ...
    >
      <div class="flex items-center gap-[10px]">
        <generic-button
          ...
          @click="$router.push('/outputToProductionCompanyReturn.htm')"
        />
        <h1 class="font-bold text-[rgb(49,126,172)] text-[14px] uppercase">
          Return of Output To Production Company
        </h1>
      </div>
    </div>
    <div>
...
export default {
  ...
  methods: {
    ...
    getPageRequest() {
      ...
      this.$axios
        .post(
          `/invoices/prepareOutputToProductionCompanyReturnNewAjaxLoad`,
          { id },
          {
            headers: {
    ...
    saveInvoice() {
      if (!this.disabledButton) {
        ...
        this.$axios
          .post(
            `/invoices/prepareCreateEditOutputToProductionCompanyReturn`,
