  ...
  <div class="w-full p-1">
    ...
    <template v-if="isCloseTable">
      ...
      <div
        ...
        "
      >
        <div class="p-2 flex flex-col items-center justify-start">
          <div class="w-[1000px] mb-2">
            <span class="flex items-center gap-2 mb-2">
              <generic-button
                name="Open Sticker"
                type="primary"
                @click="newOpenPageAction(true)"
              />
              <generic-button
                name="Open Manual Barcode"
                type="primary"
                @click="newOpenPageAction(false)"
              />
              <generic-button name="useCamQrCode2" type="primary" />
            </span>
            <span>
              <generic-input
                type="number"
...
export default {
  ...
  methods: {
    ...
    newOpenPageAction(btnType) {
      btnType
        ? window.open('/sewModelBarcodeReaderSticker.htm', '_blank')
        : window.open('/sewModelManualBarcodeReader.htm', '_blank')
    },
