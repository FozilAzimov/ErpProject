    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          type="primary"
          :margin="true"
          @click="$router.push('/prepareDesignVariant.htm')"
        />
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareDesignVariant"
            :productions-action-buttons="true"
            delete-row-url="designVariant/prepareDesignVariantDelete"
            height="600"
...
export default {
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        .post(`/designVariant/designVariants`, {
          searchForm: {
        ...
        .then(({ data: { designVariantList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = designVariantList
