    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          type="primary"
          :margin="true"
          @click="$router.push('/prepareColorDepth.htm')"
        />
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareColorDepth"
            :productions-action-buttons="true"
            delete-row-url="colorDepth/prepareColorDepthDelete"
            height="600"
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        ...
        .then(({ data: { colorDepthList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = colorDepthList
