    ...
    <template v-if="isCloseTable">
      ...
      >
        <div class="flex items-center gap-[10px]">
          ...
          <h1 class="font-bold text-[rgb(49,126,172)] text-[14px] uppercase">
            List of sew model Operation Name
          </h1>
        </div>
        <div>
      ...
      >
        <generic-button
          ...
          @click="
            $router.push({
              path: '/prepareSewModelOperationName.htm',
        ...
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareSewModelOperationName"
            :productions-action-buttons="true"
            delete-row-url="sewModelOperationName/prepareColorVariantRecipeStageChildDelete"
            height="600"
...
export default {
  ...
  data() {
    return {
      ...
      tableHead: {
        ...
        planingTypeName: {
          name: 'Planing Type Name',
          code: 'planingTypeName',
        },
      },
      tableBody: [],
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        .post(`/sewModelOperationName/sewModelOperationNameAjaxLoad`, {
          searchForm: {
        ...
        .then(({ data: { sewModelOperationNameList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = sewModelOperationNameList
