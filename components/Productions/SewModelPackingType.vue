    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          @click="$router.push('/prepareSewModelPackingType.htm')"
        />
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareSewModelPackingType"
...
export default {
  ...
  data() {
    return {
      ...
      tableHead: {
        id: { name: 'Id', code: 'id' },
        designName: {
          name: 'Sew Model Packing Type Name',
          code: 'name',
        },
      },
      tableBody: [],
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        .post(`/sewModelPackingTypes/sewModelPackingType`, {
          searchForm: {
        ...
        .then(({ data: { sewModelPackingTypeList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = sewModelPackingTypeList
