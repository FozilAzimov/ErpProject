    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          type="primary"
          :margin="true"
          @click="$router.push('/prepareColorVariantRecipeStageChild.htm')"
        />
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareColorVariantRecipeStageChild"
...
export default {
  ...
  data() {
    return {
      ...
      tableHead: {
        ...
        name: {
          name: 'Color Variant Recipe Stage Child Name',
          code: 'name',
        },
      },
      tableBody: [],
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        .post(
          `/colorVariantRecipeStageChild/colorVariantRecipeStageChildAjaxLoad`,
          {
            searchForm: {
        ...
        .then(({ data: { colorVariantRecipeStageChildList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = colorVariantRecipeStageChildList
