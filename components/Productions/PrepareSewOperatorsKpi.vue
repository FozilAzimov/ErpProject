      ...
      >
        <div class="flex items-center gap-[10px]">
          ...
          <h1 class="font-bold text-[rgb(49,126,172)] text-[14px] uppercase">
            {{
              btnType === 'view'
                ? 'View Sew Operators KPI'
                : btnType === 'edit'
                ? 'Edit Sew Operators KPI'
                : 'Add Sew Operators KPI'
            }}
          </h1>
        </div>
        <div>
...
export default {
  ...
  methods: {
    ...
    goBackAction() {
      ...
      this.$router.push('/sewOperatorsKPI.htm')
    },
    ...
    dataCreatedAction() {
      const data = [
        ...
        {
          name: 'Sew Model Operation Name',
          subName: 'sewModelOperationName',
          type: 'select',
        },
        {
          name: 'Person',
        ...
        {
          name: 'Total Time In Second',
          subName: 'totalTimeInSecond',
          type: 'text',
        },
        {
          name: 'Time Per Qty',
