    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          @click="
            $router.push({
              path: '/prepareSubDepartments.htm',
        ...
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareSubDepartments"
            :productions-action-buttons="true"
            delete-row-url="subDepartment/subDepartmentDelete"
            height="600"
...
export default {
  ...
  methods: {
    getTableRequest() {
      ...
      this.$axios
        .post(`/subDepartment/subDepartmentsAjaxLoad`, {
          searchForm: {
        ...
        .then(({ data: { subDepartmentList } }) => {
          this.tableBody = subDepartmentList
