    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          @click="
            $router.push({
              path: '/prepareProductCategory.htm',
        ...
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareProductCategory"
            :productions-action-buttons="true"
            delete-row-url="productCategory/prepareProductCategoryDelete"
            height="600"
...
export default {
  ...
  data() {
    return {
      ...
      tableHead: {
        ...
        generatedTypeName: {
          name: 'Code Generation Type',
          code: 'generatedTypeName',
        },
        productCount: {
          name: 'Product Count',
          code: 'productCount',
  ...
  methods: {
    getTableRequest() {
      ...
      this.$axios
        .post(`/productCategory/productCategoriesAjaxLoad`, {
          searchForm: {
        ...
        .then(({ data: { productCategoryList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = productCategoryList
