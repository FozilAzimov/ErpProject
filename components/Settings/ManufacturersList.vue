      ...
      >
        ...
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareManufacturer"
            :productions-action-buttons="true"
            delete-row-url="manufacturer/prepareManufacturerDelete"
            height="600"
...
export default {
  ...
  methods: {
    getTableRequest() {
      ...
      this.$axios
        .post(`/manufacturer/manufacturers`, {
          searchForm: {
        ...
        .then(({ data: { manufacturerList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = manufacturerList
