...
export default {
    ...
    return {
      ...
      tableHead: {
        ...
        telegramBotName: {
          ...
          code: 'telegramBotName',
        },
        telegramBotChatId: {
          name: 'phoneNumber.telegramChatId',
          code: 'telegramBotChatId',
        },
        active: {
          name: 'Status',
          code: 'active',
  ...
  methods: {
    getTableRequest() {
      ...
      this.$axios
        .post(`/phoneNumber/phoneNumbersAjaxLoad`, {
          searchForm: {
        ...
        .then(({ data: { phoneNumberList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = phoneNumberList
