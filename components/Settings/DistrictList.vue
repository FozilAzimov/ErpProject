      ...
      >
        ...
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareDistrict"
            :productions-action-buttons="true"
            delete-row-url="district/districtDelete"
            height="600"
...
export default {
  ...
  methods: {
    getTableRequest() {
      ...
      this.$axios
        .post(`/district/districtAjaxLoad`, {
          searchForm: {
        ...
        .then(({ data: { districtList } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = districtList
