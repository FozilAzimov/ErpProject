    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          @click="
            $router.push({
              path: '/prepareProductionArticle.htm',
        ...
        <div class="p-2">
          ...
          <GenericTablePage
            ...
            open-url="prepareProductionArticle"
            :productions-action-buttons="true"
            delete-row-url="productionArticle/prepareProductionArticleDelete"
            height="600"
...
export default {
  ...
  methods: {
    getTableRequest() {
      ...
      this.$axios
        .post(`/productionArticle/productionArticlesAjaxLoad`, {
          searchForm: {
