    ...
    <template v-if="isCloseTable">
      ...
      >
        <generic-button
          ...
          @click="$router.push('/preparePaymentType.htm')"
        />
        <div class="p-2">
    ...
    return {
      ...
      tableHead: {
        ...
        paymentTypeGroupName: {
          name: 'Paymenttype Group',
          code: 'paymentTypeGroupName',
        },
        name: {
  ...
  methods: {
    ...
    getTableRequest() {
      ...
      this.$axios
        ...
        .then(({ data: { paymentTypes } }) => {
          this.isLoading = !this.isLoading
          this.tableBody = paymentTypes
